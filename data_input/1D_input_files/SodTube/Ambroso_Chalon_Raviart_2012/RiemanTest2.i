...
###### Initial Conditions #######
pressure_init_left = 5.
pressure_init_right = 12.8567
pressure_init_left_gas = 1.
pressure_init_right_gas = 0.1
vel_init_left = 0.3
vel_init_right = 0.3
vel_init_left_gas = 2.
vel_init_right_gas = 2.8011
temp_init_left = 2.5
temp_init_right = 6.42885
temp_init_left_gas = 1.
temp_init_right_gas = 0.51519835
alpha_init_left = 0.8
...
[Executioner]
  ...
  [./TimeStepper]
    type = FunctionDT
    time_t =  '0      1.e-4  7.e-4'
    time_dt = '1.e-4  1.e-4  1.e-4'
  [../]
  [./Quadrature]
    type = GAUSS
    order = SECOND
