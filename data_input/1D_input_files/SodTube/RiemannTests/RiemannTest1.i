...
rho_init_left_liq = 1.
rho_init_right_liq = 0.125
rho_init_left_gas = 1.
rho_init_right_gas = 0.125
alpha_init_left = 0.9
alpha_init_right = 0.9
membrane = 0.3
length = 0.
[]
...
[Materials]
  [./ViscCoeffLiq]
    ...
    pressure = pressure_aux_l
    density = density_aux_l
    jump_grad_press = jump_grad_press_smooth_aux_g
  ...
  [./ViscCoeffGas]
    ...
    jump_grad_dens = jump_grad_dens_smooth_aux_l # jump_grad_dens_aux_g
    vf_liquid = alpha_aux_l
    eos = eos_gas
    isLiquid = false
